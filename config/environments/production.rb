...
Rails.application.configure do # rubocop:disable Metrics/BlockLength
  ...
  config.active_storage.service = ENV['STAGING'].present? ? :gcs_staging : :gcs_production
  ...
  # 1-15-24: Rails 7.1 has force_ssl uncommmented, jfyi
  ...
  # config.active_job.queue_name_prefix = "rhouse2_production"
